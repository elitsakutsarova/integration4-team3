...
function NavItem({ label, to, matchActive, onClick, children }) {
  const location = useLocation();
  const active = matchActive?.(null, location) ?? false;
...
export default function BottomNav({ onAddClick }) {
  ...
  return (
    <nav className="bottom-nav" aria-label="Main navigation">
      <NavItem label="Home" to={paths.home} matchActive={isHomeNavActive}>
      ...
      <NavItem label="Discover" to={paths.discover} matchActive={isDiscoverNavActive}>
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" fill="none">
      ...
      <NavItem label="Journals" to={paths.journals} matchActive={isJournalNavActive}>
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" fill="none">
      ...
      <NavItem label="Profile" to={paths.profile} matchActive={isProfileNavActive}>
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" fill="none">
