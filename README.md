# integration4-team3 — MemoMe

Team 3 project for Integration 4: an Antwerp memory map and travel journal web app.
...
# Add Supabase keys to .env.local — see memome_app/README.md
npm run dev
```
...
Full setup guide (system requirements, `.env` variables, step-by-step install, and online service configuration):

→ **[memome_app/README.md](memome_app/README.md)**
